...
<head>
	...
	<body class="premium standard u-fix-fancybox-iframe">
		<form>
			...
			<!-- ??? -->
			<asp:Literal runat="server" ID="artistID"></asp:Literal>
			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						<asp:Image runat="server" class="details-banner--hero--img" ID="artistHeroImage" alt="Artist Hero URL" />
					</div>

                    <!-- Banner Artist Image -->
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
							<asp:Image runat="server" class="details-banner--info--box--img" ID="artistBoxImage" alt="Artist Image URL" />	
						</a>
						<!-- Banner Artist Name -->
