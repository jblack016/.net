...
<head>
	...
	<body class="premium standard u-fix-fancybox-iframe">
		<form runat="server">
			...
			<!-- Artist ID -->
			<asp:Literal runat="server" ID="artistDetailsLit"></asp:Literal>
			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						<asp:Image runat="server" class="details-banner--info--box--img" ID="artistHero" />
					</div>
					...
					<div class="details-banner--info">
						...
						<h1 class="details-banner--info--name">
							<a class="details-banner--info--name--link" href="#">
								<asp:Literal runat="server" ID="artistName"></asp:Literal></a></h1>
					</div>
				</div>
							...
							<main class="discovery--section">
								...
								<section class="standard--holder">
									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										<asp:Repeater ID="songListRepeater" runat="server" >
											<ItemTemplate>
												<li class="song-list--item media-player--row">

													<div class="song-list--item--player-img media-player">
														<asp:Image runat="server" class="song-list--item--player-img--img" ID="artistImage" ImageUrl='<%# Eval("albumImage") %>' />
													</div>
													<div class="song-list--item--right">

														<!-- Song Details -->

														<a href="#" class="song-list--item--primary"><asp:Literal ID="songTitle" runat="server" Text='<%# Eval("songTitle") %>'></asp:Literal></a>
														<a class="song-list--item--secondary"><asp:Literal ID="albumTitle" runat="server" Text='<%# Eval("albumTitle") %>'></asp:Literal></a>
														<a class="song-list--item--secondary"><asp:Literal ID="songBpm" runat="server" Text='<%# Eval("songBpm") %>'></asp:Literal> bpm</a>
														<a class="song-list--item--secondary"><asp:Literal ID="songTimeSig" runat="server" Text='<%# Eval("songTimeSig") %>'></asp:Literal></a>
									...
									<section class="standard--holder">
										...
										<div class="discovery--grid-holder">
											...
											<div class="ly-grid ly-grid-cranberries">
												<asp:Repeater runat="server" ID="albumListRepeater">
													<ItemTemplate>
														<div class="media-item">
															<a class="media-item--img--link" href="#" tabindex="0">
																<asp:Image class="media-item--img" runat="server" ID="albumImage" ImageUrl='<%# Eval("albumImage") %>' />
																<span class="image-tag">Master</span>
															</a>
															<a class="media-item--title" href="#" tabindex="0">
																<asp:Literal runat="server" ID="albumTitle" Text='<%# Eval("albumTitle") %>'></asp:Literal>
															</a>
															<a class="media-item--subtitle" href="#" tabindex="0">
																<asp:Literal runat="server" ID="artistName" Text='<%# Eval("artistName") %>'></asp:Literal>
															</a>
														</div>
													</ItemTemplate>
												</asp:Repeater>
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										<p><asp:Literal ID="artistBio" runat="server"></asp:Literal></p>
										<a href="#">Read More...</a>
									</div>
